...
module.load = function(c, config)
  ...
  return {
    ...
    Folded       = { fg = c.s4, bg = c.bg_lighten5 },
    FoldColumn   = { fg = c.s3, bg = c.bg },
    MatchParen   = { fg = c.fg, bg = c.s2, gui = 'bold' },
    ErrorMsg     = { fg = c.error, bg = c.bg },
    WarningMsg   = { fg = c.d55 },
    MsgSeparator = { bg = c.d25 },
    EndOfBuffer  = { fg = c.s3 },
    DiffAdd      = { fg = c.fg, bg = t(c.bg, 100, 20, 15) },
    DiffChange   = { fg = c.fg, bg = t(c.bg, 200, 20, 15) },
    DiffDelete   = { fg = c.fg, bg = t(c.bg, 0, 20, 15) },
    DiffText     = { fg = c.fg, bg = t(c.bg, 200, 20, 15), gui = 'underline' },
    TabLine      = { bg = c.s2 },
    TabLineFill  = { bg = c.s2 },
    TabLineSel   = { fg = c.d45 },
    Title        = { fg = c.blue },
    ...
    StatusLine   = { fg = c.fg, bg = c.s2 },
    Directory    = { fg = c.blue },
    QuickFixLine = { fg = c.fg, bg = c.d25 },
    Whitespace   = { fg = c.bg_lighten5 },
    StatusLineNC = { fg = c.s4, bg = c.bg_lighten5 },
    -- Substitute   = {},
    -- SpellBad     = { },
    -- SpellCap     = { },
    -- SpellLocal   = { },
    ...
    LspReferenceText   = { bg = c.bg_lighten5 },
    LspReferenceRead   = { bg = c.bg_lighten5 },
    LspReferenceWrite  = { bg = c.bg_lighten5, gui = 'bold' },
    ...
    -- Symbols-Outline
    FocusedSymbol                          = { bg = c.bg_lighten5 },
    SymbolsOutlineConnector                = { fg = c.s2 },

    -- Fugitive
    diffAdded                              = { fg = c.fg, bg = t(c.bg, 100, 20, 15) },
    diffLine                               = { fg = c.fg, bg = t(c.bg, 200, 20, 15) },
    diffRemoved                            = { fg = c.fg, bg = t(c.bg, 0, 20, 15) },
    fugitiveStagedHeading                  = { fg = c.green },
    fugitiveUntrackedModifier              = { fg = c.red },
    fugitiveUnstagedModifier               = { fg = c.d65 },
    ...
    DapUIDecoration                        = { fg = c.d25 },
    DapUIThread                            = { fg = c.d65 },
    DapUIStoppedThread                     = { fg = c.d45 },
    DapUIFrameName                         = { fg = c.fg },
    DapUISource                            = { fg = c.d45 },
    DapUILineNumber                        = { fg = c.blue },
    DapUIFloatBorder                       = {},
    DapUIWatchesEmpty                      = { fg = c.s3 },
    DapUIWatchesValue                      = { fg = c.d25 },
    DapUIWatchesError                      = { fg = c.error },
    DapUIBreakpointsPath                   = { fg = c.d65 },
