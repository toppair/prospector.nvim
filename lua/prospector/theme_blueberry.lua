...
function module.load(base, config)
    ...
    return {
      ...
      TSFuncMacro          = { fg = p.cyan, gui = 'italic' },
      TSInclude            = { fg = p.red },
      TSKeyword            = { fg = p.purple },
      TSKeywordFunction    = { fg = p.purple },
      TSKeywordOperator    = { fg = p.purple },
      ...
      TSSymbol             = { fg = p.cyan },
      TSType               = { fg = p.orange },
      TSTypeBuiltin        = { fg = p.orange, gui = 'bold' },
      TSVariable           = { fg = p.fg },
      ...
      TSWarning            = { fg = t(p.orange, 0, 0, -5), gui = 'bold' },
